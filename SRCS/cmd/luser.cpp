...
/*   Updated: 2023/05/24 18:16:27 by cmaginot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::vector<Reply>	Server::lusers(User *user, std::vector<std::string> args) // do not use
{
	...
	else
	{
		...
		reply[0].add_arg("LUSERS", "command");
